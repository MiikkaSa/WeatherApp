...
export default function Home() {
  ...
  const { isLoading, error, data, refetch } = useQuery<WeatherData>(
    ...
    async () => {
      const { data } = await axios.get(
        `https://api.openweathermap.org/data/2.5/forecast?q=${place}&appid=be0236190e9e4812247995cc18ed78ef&cnt=56`
      );
      return data;
    }
  );
  ...
  console.log("process.env.WEATHER_KEY", process.env.WEATHER_KEY);
              ...
              <div className="flex gap-4">
                ...
                <Container className="bg-yellow-300/80 px-6 gap-4 justify-between overflow-x-auto">
                  <WeatherDetails
                    ...
                    sunset={format(
                      fromUnixTime(data.city.sunset ?? 1702949452), 'H:mm'
                    )}
...
// https://api.openweathermap.org/data/2.5/forecast?q=imatra&appid=be0236190e9e4812247995cc18ed78ef&cnt=56
//   fetch('https://api.openweathermap.org/data/2.5/forecast?q=imatra&appid=be0236190e9e4812247995cc18ed78ef&cnt=56').then(res =>
//     res.json()
//   )